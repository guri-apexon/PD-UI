...
import { paramsLocation, indication, sponser, searchResult, NosearchResult } from "./data";
...
describe("Search.js Render", () => {
  ...
  test("Render Search Component successfully with all Filters", () => {
    ...
    fireEvent.click(tocCollapse.children[0].children[1].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0]);
    let phaseCollapse= container.getByTestId('phase-checkboxes');
    fireEvent.click(phaseCollapse.children[0]);
    fireEvent.click(phaseCollapse.children[0].children[1].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0]);
    let documentCollapse= container.getByTestId('document-checkboxes');
    fireEvent.click(documentCollapse.children[0]);
    fireEvent.click(documentCollapse.children[0].children[1].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0].children[0]);
