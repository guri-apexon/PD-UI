...
describe('EditFootNote', () => {
  ...
  it('updates state and setFootnoteData on blur', async () => {
    ...
    fireEvent.blur(contentEditable, { relatedTarget: null });

    // const contentEditable = await getByRole('textbox');
    // fireEvent.change(contentEditable, { target: { innerHTML: newContent } });
