...
const Table = (props) => {
  ...
  const handleTableSubmit = () => {
    ...
    console.log(
      ...
      JSON.stringify(JSON.stringify(tableJSON))
    );
    let itemClone = cloneDeep(item);
    const table = JSON.stringify(tableJSON);
    itemClone.content.TableProperties = table;
    console.log("Final Format Payload", itemClone);
  };
