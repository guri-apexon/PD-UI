...
describe('NewUser Screen', () => {
  ...
  test('should create user with all values', () => {
    ...
    const editFirstName = screen.getByTestId('first-name-texfield').children[1]
      .children[0];
    const editLastName =
  ...
  test('should change the First Name', () => {
    ...
    const edit = screen.getByTestId('first-name-texfield').children[1]
      .children[0];
  ...
  test('should change the email', () => {
    ...
    const edit = screen.getByTestId('email-texfield').children[1].children[0];
  ...
  test('should change the country', () => {
    ...
    const edit = screen.getByTestId('Country-texfield').children[1].children[0];
  ...
  test('should change the userID', () => {
    ...
    const edit = screen.getByTestId('user-id-texfield').children[1].children[0];
  ...
  test('should change the user role', () => {
    ...
    const edit = screen.getByTestId('user-role-select').children[1].children[1];
  ...
  test('should focus the first name show required message', () => {
    ...
    const edit = screen.getByTestId('first-name-texfield');
  ...
  test('should focus the last name show required message', () => {
    ...
    const edit = screen.getByTestId('last-name-texfield');
    fireEvent.change(edit.children[1].children[0], { target: { value: '' } });
    fireEvent.focusOut(edit.children[1].children[0]);
    const create = screen.getByText('Create');
    fireEvent.click(create);
  ...
  test('should focus the email show required message', () => {
    ...
    const edit = screen.getByTestId('email-texfield');
    fireEvent.change(edit.children[1].children[0], { target: { value: '' } });
    fireEvent.focusOut(edit.children[1].children[0]);
    const create = screen.getByText('Create');
    fireEvent.click(create);
  ...
  test('should focus the country show required message', () => {
    ...
    const edit = screen.getByTestId('Country-texfield');
    fireEvent.change(edit.children[1].children[0], { target: { value: '' } });
    fireEvent.focusOut(edit.children[1].children[0]);
    const create = screen.getByText('Create');
    fireEvent.click(create);
  ...
  test('should focus the user id show required message', () => {
    ...
    const edit = screen.getByTestId('user-id-texfield');
    fireEvent.change(edit.children[1].children[0], { target: { value: '' } });
    fireEvent.focusOut(edit.children[1].children[0]);
    const create = screen.getByText('Create');
    fireEvent.click(create);
  ...
  test('should focus the user role show required message', () => {
    ...
    const edit = screen.getByTestId('user-role-select');
