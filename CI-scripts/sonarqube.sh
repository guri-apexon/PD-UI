...
sonar-scanner \
  ...
  -Dsonar.exclusions=node_modules/*,coverage/*,src/features/**/**/*.test.js,src/features/**/**/**/*.test.js,src/features/**/**/**/**/*.test.js,src/test-utils,src/features/Container/Protocols/CompareCard.js,src/features/Container/Protocols/CompareCardNew.js,src/features/Container/Protocols/compareTable.js,src/features/Container/Protocols/Documents_back.js,src/features/Container/Search/Data/row.data.js,src/features/Container/Search/Data/row.js,src/features/Container/Search/Data/search.metadata.js,src/utils/api.js,src/features/Components/Dashboard/QCTable.js,src/features/Components/Dashboard/ProtocolTable.js,src/App.js,src/App.test.js,src/AppConstant/AppConstant.js,src/index.js,src/Routes/routes.test.js,src/Routes/routesConstant.js,src/SessionOut.js,src/test-utils/test-utils.js,src/utils/utilFunction.js \
